...
export function df_get_delay(st) {
  const ret = wasm.df_get_delay(st)
  return ret >>> 0
}
...
export function df_process_frames(st, input) {
  const ptr0 = passArrayF32ToWasm0(input, wasm.__wbindgen_malloc)
  const len0 = WASM_VECTOR_LEN
  const ret = wasm.df_process_frames(st, ptr0, len0)
...
function __wbg_finalize_init(instance, wasmModule) {
  wasm = instance.exports
  cachedFloat32Memory0 = null
  cachedUint8Memory0 = null
  return wasm
}
function initSync(wasmModule) {
