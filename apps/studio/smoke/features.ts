...
export const FEATURE_TABLE: readonly Feature[] = [
  ...
  feature('move-across-tracks', 'Drag a clip onto another track, then undo it in one step', 'fast'),
  feature('reorder-tracks', 'Reorder tracks by dragging the header grip and with the arrow keys', 'fast'),
  ...
  feature('center-person', 'Center a moving face in a 9:16 crop on this device, including the first-run face model download', 'full'),
