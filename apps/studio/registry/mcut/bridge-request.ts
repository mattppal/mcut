...
const request = <Type extends string, Payload extends z.ZodType>(type: Type, payload: Payload) =>
  z.object({ id: z.string(), type: z.literal(type), payload });
...
export type BridgeFrame =
  ...
  | { ok: false; id: string | undefined; error: BridgeRequestError };
