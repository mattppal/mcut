...
export async function dragAssetToLane(page: Page, cardTitle: RegExp, options: { laneIndex?: number; offsetX?: number } = {}): Promise<void> {
...
export async function openLeftTab(page: Page, tab: 'media' | 'text' | 'animate' | 'captions'): Promise<void> {
