...
[mcut SDK](../../../index.mdx) / [timeline/src](../index.mdx) / getElement

# Function: getElement()

```ts
function getElement(project, elementId): TimelineElement | undefined;
```

Defined in: [packages/timeline/src/selectors.ts:29](https://github.com/mattppal/mcut/blob/main/packages/timeline/src/selectors.ts#L29)
...
[`TimelineElement`](../type-aliases/TimelineElement.mdx) \| `undefined`
