...
[mcut SDK](../../../index.mdx) / [timeline/src](../index.mdx) / getProjectDurationMs

# Function: getProjectDurationMs()

```ts
function getProjectDurationMs(project): number;
```

Defined in: [packages/timeline/src/selectors.ts:50](https://github.com/mattppal/mcut/blob/main/packages/timeline/src/selectors.ts#L50)
