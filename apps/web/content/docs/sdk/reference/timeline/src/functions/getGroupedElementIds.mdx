...
[mcut SDK](../../../index.mdx) / [timeline/src](../index.mdx) / getGroupedElementIds

# Function: getGroupedElementIds()

```ts
function getGroupedElementIds(project, elementId): `e-${string}`[];
```

Defined in: [packages/timeline/src/selectors.ts:53](https://github.com/mattppal/mcut/blob/main/packages/timeline/src/selectors.ts#L53)
