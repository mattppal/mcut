...
[mcut SDK](../../../index.mdx) / [timeline/src](../index.mdx) / findThumbnailTrack

# Function: findThumbnailTrack()

```ts
function findThumbnailTrack(project):
  | {
...
Defined in: [packages/timeline/src/thumbnails.ts:177](https://github.com/mattppal/mcut/blob/main/packages/timeline/src/thumbnails.ts#L177)
