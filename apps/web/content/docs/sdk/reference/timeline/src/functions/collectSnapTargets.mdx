...
[mcut SDK](../../../index.mdx) / [timeline/src](../index.mdx) / collectSnapTargets

# Function: collectSnapTargets()

```ts
function collectSnapTargets(project, options?): SnapTarget[];
```

Defined in: [packages/timeline/src/snap.ts:57](https://github.com/mattppal/mcut/blob/main/packages/timeline/src/snap.ts#L57)
