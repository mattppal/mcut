...
[mcut SDK](../../../index.mdx) / [timeline/src](../index.mdx) / getAngleTransitionAt
...
Defined in: [packages/timeline/src/multicam.ts:105](https://github.com/mattppal/mcut/blob/main/packages/timeline/src/multicam.ts#L105)
