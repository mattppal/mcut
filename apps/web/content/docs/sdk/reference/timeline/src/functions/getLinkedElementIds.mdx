...
[mcut SDK](../../../index.mdx) / [timeline/src](../index.mdx) / getLinkedElementIds

# Function: getLinkedElementIds()

```ts
function getLinkedElementIds(project, elementId): `e-${string}`[];
```

Defined in: [packages/timeline/src/selectors.ts:37](https://github.com/mattppal/mcut/blob/main/packages/timeline/src/selectors.ts#L37)
