...
[mcut SDK](../../../index.mdx) / [timeline/src](../index.mdx) / getActiveLayout
...
Defined in: [packages/timeline/src/multicam.ts:31](https://github.com/mattppal/mcut/blob/main/packages/timeline/src/multicam.ts#L31)
